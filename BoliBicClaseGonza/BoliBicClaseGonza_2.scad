...
translate([0, 60,0]) penword(" Vera", 1.5, 0.81, 80);
translate([0, 40,0]) penword(" Jazmin", 1.5, 0.81, 80);
translate([0, 20,0]) penword(" Javier", 1.5, 0.81, 80);
translate([0, 0,0]) penword(" Marcos", 1.5, 0.81, 80);
translate([0, -20,0]) penword(" Javier", 1.5, 0.81, 80);
