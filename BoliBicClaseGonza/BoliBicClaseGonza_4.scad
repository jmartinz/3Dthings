...
translate([0, 60,0]) penword(" Paula", 1.5, 0.81, 80);
translate([0, 40,0]) penword(" Olivia", 1.5, 0.81, 80);
translate([0, 20,0]) penword(" Hector", 1.5, 0.81, 80);
translate([0, 0,0]) penword(" Raquel", 1.5, 0.81, 80);
translate([0, -20,0]) penword(" Sara", 1.5, 0.81, 80);
translate([0, -40,0]) penword(" Oscar", 1.5, 0.81, 80);
translate([0, -60,0]) penword(" Jose", 1.5, 0.81, 80);
