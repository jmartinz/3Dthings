...
module penword(word, font_scale, font_spacing, pen_length )
{
...
translate([0, 60,0]) penword(" Diego", 1.5, 0.81, 80);
translate([0, 40,0]) penword(" Carlos", 1.5, 0.81, 80);
translate([0, 20,0]) penword(" Martina", 1.5, 0.81, 80);
translate([0, 0,0]) penword(" Rocio", 1.5, 0.81, 80);
translate([0, -20,0]) penword(" Nacho", 1.5, 0.81, 80);
translate([0, -40,0]) penword(" Adriana", 1.5, 0.81, 80);
translate([0, -60,0]) penword(" Maria", 1.5, 0.81, 80);
