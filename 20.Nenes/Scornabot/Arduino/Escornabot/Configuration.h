...
#define BS_ANALOG_VALUE_UP 420
#define BS_ANALOG_VALUE_RIGHT 561
#define BS_ANALOG_VALUE_DOWN 702
#define BS_ANALOG_VALUE_LEFT 280
#define BS_ANALOG_VALUE_GO 970
#define BS_ANALOG_VALUE_RESET 849
