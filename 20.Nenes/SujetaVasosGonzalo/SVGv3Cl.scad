...
module aro(grosor_aro=20,  diam_ext=80, diam_int = 63.3, texto = "Claudia")
{
 ...
 difference(){
  difference() {
    ...
    //-- Taladro aro
   cylinder(r1=diam_int/2+2, r2=diam_int/2-2,h=grosor_aro*3,$fn=100,center=true);
 }
}
...
module cuerpo_sv(grosor_aro=20,  diam_ext=80, diam_int = 65, texto = "Claudia",altura=40, diam_tubo = 63){
