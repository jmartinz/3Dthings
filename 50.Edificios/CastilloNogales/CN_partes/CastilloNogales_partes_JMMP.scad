...
module castillo(){
    translate([-0.15,-0.15,-4])torre_homenaje();
	castilloSinTorre();

}
module castilloSinTorre(puente=true){
	...
	translate([-dCubo,-dCubo,-4])muralla(puente);

    // la tierra entre el cubo y la muralla TODO hacerla paramétrica
    translate([6,6,-1])difference(){
		cube(size=[20,20,6],center=true);
		cube(size=[12.3,12.3,60],center=true);
	}
...
module tierra(){
	difference(){
		...
		/*rotate([0,0,45])translate([70+20,0,0])cube(size=[140,140,140],center=true);
		rotate([0,0,45])translate([-70-20,0,0])cube(size=[140,140,140],center=true);
		rotate([0,0,45])translate([0,70+20,0])cube(size=[140,140,140],center=true);
		rotate([0,0,45])translate([0,-70-20,0])cube(size=[140,140,140],center=true);
		translate([0,0,-75])cube(size=[140,140,140],center=true);*/
		difference(){
			cube(size=[110,1000,50],center=true);
		...
		rotate([0,0,55])cube(size=[12,12,60],center=true);
	}
...
module agujeroTH(){
	...
	intersection(){
		cube(size=[12.3-2,12.3-2,22.7-radioSphera+4]);
		translate([radioSphera-.1,radioSphera-.1,-radioSphera+4])cylinder(h = 22.7, r2 = (12.3-2)/2, r1 = 12.3-2, center = false, $fn=20);
	}
	translate([radioSphera-.1,radioSphera-.1,22.7-radioSphera+4])sphere(r = radioSphera);
}
...
module tierraSinCastillo(){
    difference(){
        rotate([0,0,-55])tierra();
        scale([1.01,1.01,1])translate([-12.3/2,-12.3/2,0])castillo();
...
//tierraSinCastillo();
//translate([-12.3/2,-12.3/2,0])%color("red")
castilloSinTorre(false);
//scale([0.99,0.99,1])translate([-12.6/2,-12.6/2,-4])
//torre_homenaje();
// puente
//color("blue")
//cube(size=[1.5,4.8,0.2]);
