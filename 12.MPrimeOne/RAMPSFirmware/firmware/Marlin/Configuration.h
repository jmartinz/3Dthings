...
#define CUSTOM_MACHINE_NAME "M Prime 007"
...
const bool Z_MIN_ENDSTOP_INVERTING = false; // With inductive sensor: true for NPN, false for PNP
const bool X_MAX_ENDSTOP_INVERTING = true; // set to true to invert the logic of the endstop. JMMP
...
// Invert the stepper direction (extruder stepper). Change (or reverse the motor connector) if an axis goes the wrong way.
