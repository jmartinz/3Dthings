...
#define STRING_CONFIG_H_AUTHOR "(jmmp, SAV MkI)" //Who made the changes.
...
#define CUSTOM_MACHINE_NAME "M Prime SAV"

// Define this to set a unique identifier for this printer, (Used by some programs to differentiate between machines)
// You can use an online service to generate a random UUID. (eg http://www.uuidgenerator.net/version4)
#define MACHINE_UUID "8fa360f0-8b0a-4687-8d04-a2c5407dfd07"
...
#define TEMP_SENSOR_0 5 //E3D Lite6
...
#define HEATER_0_MINTEMP 5 //E3D Lite6
...
const bool Z_MIN_ENDSTOP_INVERTING = true; // With inductive sensor: true for NPN, false for PNP
...
#define Z_MIN_PROBE_REPEATABILITY_TEST  // If not commented out, Z-Probe Repeatability test will be included if Auto Bed Leveling is Enabled.
  ...
  #define Y_PROBE_OFFSET_FROM_EXTRUDER -24     // Z probe to nozzle Y offset: -front +behind
