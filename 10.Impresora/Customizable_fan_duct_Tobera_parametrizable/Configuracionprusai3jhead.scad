...
//ES: 4.- CONO TOBERA (es el cono que va desde el ventilador hasta la boquilla)
	...
	DT=17;		//EN	Distance from the fan duct to the XY plane.
...
//SP: 5.- SOPORTE
	DSX1=25;
	DSY1=0;
	DSZ1=40;		//EN:	(DSX1,DSY1,DSZ1) distance from the center of the "half-donut" to the first hole of the support
				//SP:	(DSX1,DSY1,DSZ1) distancia desde el centro del "semi-donut" al primer taladro del soporte

	DSX2=-25;
	DSY2=0;
	DSZ2=40;		//EN:	(DSX2,DSY2,DSZ2) distance from the center of the "half-donut" to the second hole of the support
